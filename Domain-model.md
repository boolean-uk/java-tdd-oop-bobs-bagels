...
| Methods                     | Member variables    | Scenario                                        | Output/result      |
|-----------------------------|---------------------|-------------------------------------------------|--------------------|
| addToBasket(String product) | String[] basketArr  | The user gets information about prices          | return productMenu |
...
| Methods                     | Member variables    | Scenario                                        | Output/result       |
|-----------------------------|---------------------|-------------------------------------------------|---------------------|
| addToBasket(String product) | String[] basketArr  | The user gets information about prices          | return confirmation |
|                             |                     | before they choose the product. Using a menu-   |                     |
|                             |                     | string that shows every product and their price |                     |
