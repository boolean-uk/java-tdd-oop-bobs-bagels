...
public class BasketEx {
    private HashMap<String, BasketItemEx> basket;
    private HashMap<String, String> bglbMap = new HashMap<>();
    private int capacity;
    private double total;
    InventoryEx inventory;
    ...
    public BasketItemEx getBasketItem(String sku) {
        return this.basket.get(sku);
    }

    public int getBasketSize() {
        int basketSize = 0;
        for (BasketItemEx basketItem: basket.values()) {
    ...
    public boolean addItem(String item, int quantity) {
        ...
        // Item not in basket, then put key by sku and value as BasketItem with name, price and quantity.
            ...
            this.basket.put(sku, new BasketItemEx(item, quantity, price));
        }
    ...
    public boolean buildBagel(int quantity, String[] fillings) {
        ...
        this.basket.put(sku, new BasketItemEx(item.substring(0, item.length()-2), quantity, bagelCost, fillings));
