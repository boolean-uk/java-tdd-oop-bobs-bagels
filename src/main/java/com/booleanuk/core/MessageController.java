...
public class MessageController {
  ...
  public static final String TWILIO_FROM_NUMBER = System.getenv("TWILIO_PHONE_NUMBER");
  ...
  public static void notifyUser(String messageContent, String toNumber) {
    Message message = Message.creator(new PhoneNumber(toNumber), new PhoneNumber(TWILIO_FROM_NUMBER), messageContent)
        .create();
