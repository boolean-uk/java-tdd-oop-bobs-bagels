...
public class Main {
    public static void main(String[] args) {
        ...
        b.add(inv.getInventory().get("BGLO"));
        b.add(inv.getInventory().get("BGLO"));
        ((Bagel)b.getBasket().get(0)).addFilling(inv.getInventory().get("FILC"));
        ((Bagel)b.getBasket().get(0)).addFilling(inv.getInventory().get("FILE"));
        ((Bagel)b.getBasket().get(1)).addFilling(inv.getInventory().get("FILE"));
