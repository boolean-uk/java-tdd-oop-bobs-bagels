...
class BasketTest {
    ...
    public void testReturnBasketIsFull() {
        ...
        basket.addBagelTypeToBasket(new Bagel("Onion"));
        basket.addBagelTypeToBasket(new Bagel("Plain"));
        basket.addBagelTypeToBasket(new Bagel("Everything"));
        basket.addBagelTypeToBasket(new Bagel("Sesame"));
        basket.addBagelTypeToBasket(new Bagel("Onion"));
    ...
    //User Story 6 Case 1 - Can remove item
    @Test
    ...
    //User Story 6 Case 2 - Can not remove item
    @Test
