...
public class BasketTest {
    ...
    public void removeBagelCorrectlyTest() {
        ...
        basket.addItem(SKU.BGLP);
        Assertions.assertEquals(1, basket.items.size());
        Assertions.assertTrue(basket.removeItem(SKU.BGLP));
    ...
    public void removeBagelIncorrectlyTest() {
        Basket basket = new Basket();
        basket.addItem(SKU.BGLP);
        Assertions.assertFalse(basket.removeItem(SKU.BGLE));
    }
    ...
    public void testetst() {
        ...
        basket.addItem(SKU.BGLO);
        basket.addItem(SKU.BGLO);
        basket.addItem(SKU.COFW);
        basket.addItem(SKU.COFW);
        basket.addItem(SKU.COFB);
        basket.addItem(SKU.COFB);
        basket.addItem(SKU.FILB);
