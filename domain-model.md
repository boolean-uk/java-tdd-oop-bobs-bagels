...
| Methods                                                   | Members                          | Scenario                                                                                        | Output                                    |
|-----------------------------------------------------------|----------------------------------|-------------------------------------------------------------------------------------------------|-------------------------------------------|
| createBasket()                                            | HashMap\<String, Basket> baskets | Customer wants to shop                                                                          | A basket id as a string                   |
| getCostOfBasket(String basketId)                          | Inventory inventory              | Customer wants to know the cost of their basket                                                 | cost as a double                          |
...
| addBagelToBasket(String bagel, String basketId)           | int basketCapacity               | Customer wants to add an existing bagel to the basket when it's not full                        | "Bagel added."                            |
...
| addFilling(String filling, String bagel, String basketId) |                                  | Customer wants to add a filling that doesn't exist in the inventory                             | "Bob's bagels doesn't have that filling." |
